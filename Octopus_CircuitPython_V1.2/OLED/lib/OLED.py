...
class OLED():
    ...
    def draw_circle(self, xCircle, yCircle, radius):
        self.xCircle = xCircle
        self.yCircle = yCircle
        self.radius = radius
        self.display.circle(self.xCircle, self.yCircle, self.radius, 1)
        self.display.show()

    def draw_line(self, x1Line, y1Line, x2Line, y2Line):
        self.x1Line = x1Line
        self.y1Line = y1Line
        self.x2Line = x2Line
        self.y2Line = y2Line
    ...
    def set_pixel(self, xPixel, yPixel):
        self.xPixel = xPixel
        self.yPixel = yPixel
